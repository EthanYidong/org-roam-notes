...
- Overflow: buffer runs out of space
- Underflow: buffer becomes empty
- Protocol: use UDP
  ...
  - Encapsulate chunks in RTP (Real time protocol)
    - Contains sequence number, time stamp, and encoding information
...
- Protocol: use HTTP
  ...
  - Use max rate of TCP
  - Use byte range header to specify which region of video to get
  - Advantages
